...
pub fn usage_report(root: &Path) -> Value {
    ...
    json!({
        ...
        "fix_reintroductions_by_detector": report::fix_reintroductions_by_detector(&totals),
        ...
        "recent_30d": {
            ...
            "fix_reintroductions_by_detector": report::fix_reintroductions_by_detector(&recent),
